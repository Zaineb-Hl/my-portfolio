                    ...
                    <div className="space-y-8">
                        <div className="animate-fade-in">
                            <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass text-sm text-primary">
                                ...
                                Software Developer • Spring Boot - Angular 
                            </span>
                        </div>
                        ...
                        <div className="flex flex-wrap gap-4 animate-fade-in animation-delay-300">
                            ...
                            <Button size="lg">
                             ...
                             <a href="/CV-Zaineb-Helal.pdf" download="CV-Zaineb-Helal.pdf">
                        ...
                        <div className="flex items-center gap-4 animate-fade-in animation-delay-400">
                            ...
                            {[
                                { icon: FaGithub, href: "https://github.com/Zaineb-Hl" },
                                { icon: FaLinkedin, href: "https://www.linkedin.com/in/zaineb-helal-811257162/" },
                            ].map((social, idx) => (
                                <a
                                    key={idx}
                                    href={social.href}
